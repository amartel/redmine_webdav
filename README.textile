...
This WebDav plugin was mainly a POC (proof of concept) for accessing files and documents using WebDav protocol. 
...
This was done using REDMINE trunk r3826 (=> 0.9.5 +) but any release after 0.9 should work. Last tested revision is r5506 (1.1.2)
